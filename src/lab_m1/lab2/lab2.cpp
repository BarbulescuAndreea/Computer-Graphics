...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        vector<VertexFormat> vertices2
        {
            ...
            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0.5, 0,  -0.5), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0.5, 1,  -0.2), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6))
        };
        ...
        vector<VertexFormat> vertices3 
        {
            // coordonate, normala, culoare
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1.7, 0,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1.7, 1.7,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 1.7,  0), glm::vec3(0, 1, 2), glm::vec3(0.2, 0.8, 0.6))
        };
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(0.5f, 0.5f, 0), glm::vec3(0.45f));

    RenderMesh(meshes["tetraedru"], shaders["VertexColor"], glm::vec3(1.0f, 1.0f, 1), glm::vec3(0.45f));

    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(1.5f, 0.5f, 0.5), glm::vec3(0.45f));
